<?php
	...
	Class eventadd_to_mailing_list extends Event{
		
		const ROOTELEMENT = 'add-to-mailing-list';
		...
		public static function about(){
			return array(
					 ...
					 'version' => '1.0',
					 'release-date' => '2010-05-10T18:10:56+00:00',
					 'trigger-condition' => 'action[add-to-mailing-list]');	
		}
        ...
        <pre class="XML"><code>&lt;add-to-mailing-list result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/add-to-mailing-list></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;add-to-mailing-list result="error">
...
&lt;/add-to-mailing-list></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[add-to-mailing-list]" type="submit" value="Submit" />
&lt;/form></code></pre>
...
&lt;/form></code></pre>';
		...
		public function load(){			
			if(isset($_POST['action']['add-to-mailing-list'])) return $this->__trigger();
		}
